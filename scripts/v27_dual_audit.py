...
def dual_audit():
    print("[INFO] Initializing V27-BALANCED Dual Audit...")
    ...
    for mode in [HedgeMode.OPTIONS, HedgeMode.BOND_ROTATION]:
        print(f"  -> Auditing Mode: {mode.value.upper()}...")
    ...
    print("\n--- V27-BALANCED DUAL AUDIT RESULTS ---")
    print(df.to_string(index=False))
    df.to_csv("data/processed/v27_dual_audit.csv", index=False)

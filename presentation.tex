...
\begin{frame}{Visualizing the Regime (Figure 1)}
    \begin{center}
        \includegraphics[height=0.65\textheight]{plots/figure_1_regime_overlay.png}
    \end{center}
...
\begin{frame}{Dynamic Capital Allocation (Figure 2)}
    \begin{center}
        \includegraphics[height=0.65\textheight]{plots/figure_2_capital_allocation.png}
    \end{center}
...
\begin{frame}{Full Horizon Comparison (Figure 3)}
    \begin{center}
        \includegraphics[height=0.65\textheight]{plots/figure_3_equity_drawdown.png}
    \end{center}
...
\begin{frame}{Statistical Verification (Figure 4)}
    \begin{center}
        \includegraphics[height=0.65\textheight]{plots/figure_4_whites_reality_check.png}
    \end{center}
...
\begin{frame}{Regime 1: The Great Financial Crisis (2007--2009)}
    \begin{center}
        \includegraphics[height=0.60\textheight]{plots/regime_1_GFC/figure_7_equity_drawdown.png}
    \end{center}
...
\begin{frame}{Regime 2: The Secular Bull Run (2010--2019)}
    \begin{center}
        \includegraphics[height=0.60\textheight]{plots/regime_2_Bull/figure_11_equity_drawdown.png}
    \end{center}
...
\begin{frame}{Regime 3: Modern Volatility (2020--2024)}
    \begin{center}
        \includegraphics[height=0.60\textheight]{plots/regime_3_Modern/figure_15_equity_drawdown.png}
    \end{center}
...
\begin{frame}{Exp 1: Cost Breakeven (Figure R1)}
    \begin{center}
        \includegraphics[height=0.60\textheight]{plots/research/research_1_cost_sensitivity.png}
    \end{center}
...
\begin{frame}{Exp 2: Momentum Sensitivity (Figure R2)}
    \begin{center}
        \includegraphics[height=0.60\textheight]{plots/research/research_2_momentum_windows.png}
    \end{center}
...
\begin{frame}{Exp 3: Tranche Alpha (Figure R3)}
    \begin{center}
        \includegraphics[height=0.60\textheight]{plots/research/research_3_tranche_smoothing.png}
    \end{center}
...
\begin{frame}{Exp 4: Reporting Lag Stress (Figure R4)}
    \begin{center}
        \includegraphics[height=0.60\textheight]{plots/research/research_4_fundamental_lag.png}
    \end{center}
...
\begin{frame}{Exp 5: Universe Utility (Figure R5)}
    \begin{center}
        \includegraphics[height=0.60\textheight]{plots/research/research_5_universe_comparison.png}
    \end{center}
